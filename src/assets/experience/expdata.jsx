...
const ExpData = [
  ...
  },
  {
    ...
    img: ElectransLogo,
    desc: [
      'Designed and built fixture with custom firmware to test sensors and pneumatics before being integrated into final system by creating SolidWorks model, designing schematic in Altium, and sourcing components.',
  ...
  },
  {
    ...
    img: GrantMatchLogo,
    desc: [
      'Created web application using Python and Rest APIs to track and process client invoices and legal documents.',
  ...
  },
  {
    ...
    img: UwaftLogo,
    desc: [
      'Programmed C++ radar diagnostics algorithm in ROS which was implemented into vehicles autonomous driving architecture.',
  ...
  },
  {
    ...
    img: FLogo,
    desc: [
      'Developped Python script wth NumPy & Pandas to analyze data from over 1000 machine operations for setting error ranges of ultrasonic sensors.',
